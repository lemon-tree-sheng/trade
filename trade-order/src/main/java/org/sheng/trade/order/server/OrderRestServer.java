package org.sheng.trade.order.server;
...
public class OrderRestServer {
    public static void main(String[] args) throws Exception {
        // 监听端口
        Server server = new Server(ServerConfigEnum.ORDER.getPort());
        // 类似于原来的 web.xml
        ServletContextHandler servletContextHandler = new ServletContextHandler();
        servletContextHandler.setContextPath("/" + ServerConfigEnum.ORDER.getContextPath());

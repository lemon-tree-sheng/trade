package org.sheng.trade.goods.server;
...
public class GoodsRestServer {
    public static void main(String[] args) throws Exception {
        // 监听端口
        Server server = new Server(ServerConfigEnum.GOODS.getPort());
        // 类似于原来的 web.xml
        ServletContextHandler servletContextHandler = new ServletContextHandler();
        servletContextHandler.setContextPath("/" + ServerConfigEnum.GOODS.getContextPath());
